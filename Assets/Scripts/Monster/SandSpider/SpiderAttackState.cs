...
public class SpiderAttackState : MonsterState
{
    //FIXME : ScriptableObject로 변경
    private bool isAttackTrackingOn = false;
    
    public SpiderAttackState(StateMachine stateMachine, Animator anim)
    {
    ...
    {
        //Debug.Log("Combat");
        stateMachine._baseTracking.Tracking(stateMachine._playerTrans.position, 3.5f, 1000f);
